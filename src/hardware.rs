...
mod system {
    ...
    unsafe extern "RustQt" {
        ...
        type Hardware = super::HardwareRust;

    }

    impl cxx_qt::Constructor<()> for Hardware {}
    impl cxx_qt::Threading for Hardware {}
}

pub struct HardwareRust {
...
impl Drop for HardwareRust {
    fn drop(&mut self) {
        self.running.store(false, Ordering::SeqCst);
    }
}

impl cxx_qt::Initialize for system::Hardware {
            ...
            while running.load(Ordering::SeqCst) {
                ...
                let _ = qt_thread.queue(move |mut this| {
                    ...
                    if let Some((ref vendor, ref model, ref family, total, used, temp, util)) = gpu
                    {
                        ...
                        let _ = this.as_mut().set_gpu_temperature(temp as f64 / 1000.0);
